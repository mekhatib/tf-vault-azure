...
module "azure" {
  ...
  tls = var.enable_tls
  vault_cert = var.own_certs != "false" ? var.cert : module.tls-cert.vault_crt
  vault_key = var.own_certs != "false"? var.cert_key : module.tls-cert.vault_key
  ca_cert = var.own_certs != "false" ? var.ca_cert : module.tls-cert.vault_ca
