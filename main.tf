...
module "azure" {
  ...
  tls = var.enable_tls
  vault_cert = var.own_certs  ? var.cert : module.tls-certs.vault_crt
  vault_key = var.own_certs ? var.cert_key : module.tls-certs.vault_key
  ca_cert = var.own_certs ? var.ca_cert : module.tls-certs.vault_ca
